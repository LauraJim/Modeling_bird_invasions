...
ClimGrids.invasive <- mask(ClimGrids.masked,europe)
...
################################
  ...
  #mypath <- file.path("E:/SDM/broenni",species.id,paste("native range occurrende density", species.id, ".png", sep = ""))
  ...
  #mypath <- file.path("E:/SDM/broenni",species.id,paste("invasive range occurrence density", species.id, ".png", sep = ""))
  #png(file=mypath, width = 225, height = 225, units='mm', res = 300)
  #ecospat.plot.niche(z2,title="PCA-env - NA niche",name.axis1="PC1",name.axis2="PC2")
  #dev.off()
  
  # contribution of original variables
  #mypath <- file.path("E:/SDM/broenni",species.id,paste("PCA contributions", species.id, ".png", sep = ""))
  #png(file=mypath, width = 225, height = 225, units='mm', res = 300)
  ...
  #mypath <- file.path("E:/SDM/broenni",species.id,paste("niche overlap native range density", species.id, ".png", sep = ""))
  #png(file=mypath, width = 225, height = 225, units='mm', res = 300)
  #ecospat.plot.niche.dyn(z1,z2,quant=0.5,name.axis1="PC1",name.axis2="PC2",interest=1)
  #dev.off()
  
  #mypath <- file.path("E:/SDM/broenni",species.id,paste("niche overlap invasive range density", species.id, ".png", sep = ""))
  #png(file=mypath, width = 225, height = 225, units='mm', res = 300)
...
write.table(niche.results,"niche_results.txt",sep="\t",row.names=FALSE)
