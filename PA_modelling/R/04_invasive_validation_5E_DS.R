...
dir.create("../DS/5E/DS_inv_region_tables/")
dir.create("../DS/5E/DS_MESS_JPGs")
...
for (species in species_list) {
  ...
  fne_pred_inv_rst <- rast(paste0("D:/Ststrubb/OneDrive - UGent/Projects/MC_paper/Modeling_bird_invasions/Nf_modeling/Results-v3/", species, "_suitability_map_inv.tif"))
  ...
  write.csv(dat_inv, paste0("../DS/5E/DS_inv_region_tables/", species, "_inv_region_table.csv"), row.names = FALSE)
...
for (species in species_list) {
  ...
  fne_pred_nat_rst <- rast(paste0("D:/Ststrubb/OneDrive - UGent/Projects/MC_paper/Modeling_bird_invasions/Nf_modeling/Results-v3/", species, "_suitability_map_nat.tif"))
  ...
  dat_inv <- read.csv(paste0("../DS/5E/DS_inv_region_tables/", species, "_inv_region_table.csv"))
  glm_pred_inv_rst <- rast(paste0("../pred_rasters/invasive/", species, "_inv_p_glm.tif"))
  bart_pred_inv_rst <- rast(paste0("../pred_rasters/invasive/", species, "_inv_p_bart.tif"))
  fne_pred_inv_rst <- rast(paste0("D:/Ststrubb/OneDrive - UGent/Projects/MC_paper/Modeling_bird_invasions/Nf_modeling/Results-v3/", species, "_suitability_map_inv.tif"))
...
dir.create("../DS/5E/DS_eval_metrics")

write.csv(mtp_thresholds, "../DS/5E/DS_eval_metrics/mtp_thresholds.csv", row.names = FALSE)

write.csv(data.frame(species = rownames(eval_metrics_eur_full), eval_metrics_eur_full), "../DS/5E/DS_eval_metrics/eval_metrics_eur_full.csv", row.names = FALSE)
write.csv(data.frame(species = rownames(eval_metrics_eur_mess), eval_metrics_eur_mess), "../DS/5E/DS_eval_metrics/eval_metrics_eur_mess.csv", row.names = FALSE)
write.csv(data.frame(species = rownames(eval_metrics_inv_full), eval_metrics_inv_full), "../DS/5E/DS_eval_metrics/eval_metrics_inv_full.csv", row.names = FALSE)
write.csv(data.frame(species = rownames(eval_metrics_inv_mess), eval_metrics_inv_mess), "../DS/5E/DS_eval_metrics/eval_metrics_inv_mess.csv", row.names = FALSE)
