...
# 6) Save tables
  write.csv(native.bird.rare.vars,paste0("../../../0_Analyses/0_Nf_modeling/occurrences-v3/",
                                         species.id,"_native.csv"))
  write.csv(invasive.bird.rare.vars,paste0("../../../0_Analyses/0_Nf_modeling/occurrences-v3/",
...
# 7) Select random points inside accessible area and add PC values
  ...
  write.csv(rp.aa.vars,paste0("../../../0_Analyses/0_Nf_modeling/accessible-areas-v3/",
...
# 8) Create table with random points inside the invaded region
  ...
  write.csv(rp.ir.vars,paste0("../../../0_Analyses/0_Nf_modeling/accessible-areas-v3/",
...
write.csv(sum.table,"../../../0_Analyses/0_Nf_modeling/allspecies_samplesizes_v3.csv",row.names = F)
