...
for (k in 1:nrow(mles)) {
  ...
  writeRaster(suit.wn.nat,paste0("../../../0_Analyses/0_Nf_modeling/ResultsClimBioticHabitat/",species.id,
                             "_suitability_map_nat.tif"), overwrite = T)
  
  # Project model into the invaded region using 
  ...
  writeRaster(suit.wn.inv,paste0("../../../0_Analyses/0_Nf_modeling/ResultsClimBioticHabitat/",species.id,
