...
dir.create("../eval_metrics/INVASIVE/BIAS/EXTRAPOL/5E/inv_region_tables/")
...
foreach (species = species_list,.packages=c('terra','modEvA','kuenm','raster','enmSdm'))  %dopar% {
  ...
  glm_pred_inv_rst <- rast(paste0("../pred_rastersBIAS/EU/invasive/", species, "_inv_p_glm.tif"))
  bart_pred_inv_rst <- rast(paste0("../pred_rastersBIAS/EU/invasive/", species, "_inv_p_bart.tif"))
  fne_pred_inv_rst <- rast(paste0("../../0_Nf_modeling/ResultsClimate/", species, "_suitability_map_inv.tif"))
  ...
  write.csv(dat_inv, paste0("../eval_metrics/INVASIVE/BIAS/EXTRAPOL/5E/inv_region_tables/", species, "_inv_region_table.csv"), row.names = FALSE)
...
for (species in species_list) {
  ...
  fne_pred_nat_rst <- rast(paste0("../../0_Nf_modeling/ResultsClimate/", species, "_suitability_map_nat.tif"))
  ...
  dat_inv <- read.csv(paste0("../eval_metrics/INVASIVE/BIAS/EXTRAPOL/5E/inv_region_tables/", species, "_inv_region_table.csv"))
  glm_pred_inv_rst <- rast(paste0("../pred_rastersBIAS/EU/invasive/", species, "_inv_p_glm.tif"))
  bart_pred_inv_rst <- rast(paste0("../pred_rastersBIAS/EU/invasive/", species, "_inv_p_bart.tif"))
  fne_pred_inv_rst <- rast(paste0("../../0_Nf_modeling/ResultsClimate/", species, "_suitability_map_inv.tif"))
...
write.csv(mtp_thresholds, "../eval_metrics/INVASIVE/BIAS/EXTRAPOL/5E/mtp_thresholds.csv", row.names = FALSE)

write.csv(data.frame(species = rownames(eval_metrics_eur_full), eval_metrics_eur_full), "../eval_metrics/INVASIVE/BIAS/EXTRAPOL/5E/eval_metrics_eur_full.csv", row.names = FALSE)
write.csv(data.frame(species = rownames(eval_metrics_eur_mop), eval_metrics_eur_mop), "../eval_metrics/INVASIVE/BIAS/EXTRAPOL/5E/eval_metrics_eur_mop.csv", row.names = FALSE)
write.csv(data.frame(species = rownames(eval_metrics_inv_full), eval_metrics_inv_full), "../eval_metrics/INVASIVE/BIAS/EXTRAPOL/5E/eval_metrics_inv_full.csv", row.names = FALSE)
write.csv(data.frame(species = rownames(eval_metrics_inv_mop), eval_metrics_inv_mop), "../eval_metrics/INVASIVE/BIAS/EXTRAPOL/5E/eval_metrics_inv_mop.csv", row.names = FALSE)
...
dir.create("../eval_metrics/INVASIVE/BIAS/EXTRAPOL/2.5E/inv_region_tables/")
dir.create("../eval_metrics/INVASIVE/BIAS/MOP_JPGs")
...
foreach (species = species_list,.packages=c('terra','modEvA','kuenm','raster','enmSdm'))  %dopar% {
  ...
  # export table to disk:
  write.csv(dat_inv, paste0("../eval_metrics/INVASIVE/BIAS/EXTRAPOL/2.5E/inv_region_tables/", species, "_inv_region_table.csv"), row.names = FALSE)
...
for (species in species_list) {
  ...
  # import invasive occurrence data and pred rasters:
  dat_inv <- read.csv(paste0("../eval_metrics/INVASIVE/BIAS/EXTRAPOL/2.5E/inv_region_tables/", species, "_inv_region_table.csv"))
  glm_pred_inv_rst <- rast(paste0("../pred_rastersBIAS/EU/invasive/", species, "_inv_p_glm.tif"))
  bart_pred_inv_rst <- rast(paste0("../pred_rastersBIAS/EU/invasive/", species, "_inv_p_bart.tif"))
  fne_pred_inv_rst <- rast(paste0("../../0_Nf_modeling/ResultsClimate/", species, "_suitability_map_inv.tif"))
...
write.csv(mtp_thresholds, "../eval_metrics/INVASIVE/BIAS/EXTRAPOL/2.5E/mtp_thresholds.csv", row.names = FALSE)
write.csv(data.frame(species = rownames(eval_metrics_eur_full), eval_metrics_eur_full), "../eval_metrics/INVASIVE/BIAS/EXTRAPOL/2.5E/eval_metrics_eur_full.csv", row.names = FALSE)
write.csv(data.frame(species = rownames(eval_metrics_eur_mop), eval_metrics_eur_mop), "../eval_metrics/INVASIVE/BIAS/EXTRAPOL/2.5E/eval_metrics_eur_mop.csv", row.names = FALSE)
write.csv(data.frame(species = rownames(eval_metrics_inv_full), eval_metrics_inv_full), "../eval_metrics/INVASIVE/BIAS/EXTRAPOL/2.5E/eval_metrics_inv_full.csv", row.names = FALSE)
write.csv(data.frame(species = rownames(eval_metrics_inv_mop), eval_metrics_inv_mop), "../eval_metrics/INVASIVE/BIAS/EXTRAPOL/2.5E/eval_metrics_inv_mop.csv", row.names = FALSE)
