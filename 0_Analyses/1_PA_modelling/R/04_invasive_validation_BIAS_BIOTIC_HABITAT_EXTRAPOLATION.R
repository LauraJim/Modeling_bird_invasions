...
dir.create("../eval_metrics/INVASIVE/BIAS_BIOTIC_HABITAT/EXTRAPOL/5E/inv_region_tables/")
...
foreach (species = species_list,.packages=c('terra','modEvA','kuenm','raster','enmSdm'))  %dopar% {
  ...
  glm_pred_inv_rst <- rast(paste0("../pred_rastersBIAS_BIOTIC_HABITAT/EU/invasive/", species, "_inv_p_glm.tif"))
  bart_pred_inv_rst <- rast(paste0("../pred_rastersBIAS_BIOTIC_HABITAT/EU/invasive/", species, "_inv_p_bart.tif"))
  fne_pred_inv_rst <- rast(paste0("../../0_Nf_modeling/ResultsClimBioticHabitat/", species, "_suitability_map_inv.tif"))
  ...
  write.csv(dat_inv, paste0("../eval_metrics/INVASIVE/BIAS_BIOTIC_HABITAT/EXTRAPOL/5E/inv_region_tables/", species, "_inv_region_table.csv"), row.names = FALSE)
...
for (species in species_list) {
  ...
  occ_nat <- read.csv(paste0("../../0_Nf_modeling/occurrences-v3/", species, "_native.csv"))
  acc_nat <- read.csv(paste0("../../0_Nf_modeling/accessible-areas-v3/", species, "_native_range.csv"))
  glm_pred_nat_rst <- rast(paste0("../pred_rastersBIAS_BIOTIC_HABITAT/native/", species, "_nat_p_glm.tif"))
  bart_pred_nat_rst <- rast(paste0("../pred_rastersBIAS_BIOTIC_HABITAT/native/", species, "_nat_p_bart.tif"))
  fne_pred_nat_rst <- rast(paste0("../../0_Nf_modeling/ResultsClimBioticHabitat/", species, "_suitability_map_nat.tif"))
  ...
  dat_inv <- read.csv(paste0("../eval_metrics/INVASIVE/BIAS_BIOTIC_HABITAT/EXTRAPOL/5E/inv_region_tables/", species, "_inv_region_table.csv"))
  glm_pred_inv_rst <- rast(paste0("../pred_rastersBIAS_BIOTIC_HABITAT/EU/invasive/", species, "_inv_p_glm.tif"))
  bart_pred_inv_rst <- rast(paste0("../pred_rastersBIAS_BIOTIC_HABITAT/EU/invasive/", species, "_inv_p_bart.tif"))
  fne_pred_inv_rst <- rast(paste0("../../0_Nf_modeling/ResultsClimBioticHabitat/", species, "_suitability_map_inv.tif"))
...
temp$V2 <- rep("clim_biot_hab",nrow(temp))
temp$V3 <- rep("yes",nrow(temp))
...
write.csv(mtp_thresholds, "../eval_metrics/INVASIVE/BIAS_BIOTIC_HABITAT/EXTRAPOL/5E/mtp_thresholds.csv", row.names = FALSE)

write.csv(data.frame(species = rownames(eval_metrics_eur_full), eval_metrics_eur_full), "../eval_metrics/INVASIVE/BIAS_BIOTIC_HABITAT/EXTRAPOL/5E/eval_metrics_eur_full.csv", row.names = FALSE)
write.csv(data.frame(species = rownames(eval_metrics_eur_mop), eval_metrics_eur_mop), "../eval_metrics/INVASIVE/BIAS_BIOTIC_HABITAT/EXTRAPOL/5E/eval_metrics_eur_mop.csv", row.names = FALSE)
write.csv(data.frame(species = rownames(eval_metrics_inv_full), eval_metrics_inv_full), "../eval_metrics/INVASIVE/BIAS_BIOTIC_HABITAT/EXTRAPOL/5E/eval_metrics_inv_full.csv", row.names = FALSE)
write.csv(data.frame(species = rownames(eval_metrics_inv_mop), eval_metrics_inv_mop), "../eval_metrics/INVASIVE/BIAS_BIOTIC_HABITAT/EXTRAPOL/5E/eval_metrics_inv_mop.csv", row.names = FALSE)
...
dir.create("../eval_metrics/INVASIVE/BIAS_BIOTIC_HABITAT/EXTRAPOL/2.5E/inv_region_tables/")
dir.create("../eval_metrics/INVASIVE/BIAS_BIOTIC_HABITAT/MOP_JPGs")
...
foreach (species = species_list,.packages=c('terra','modEvA','kuenm','raster','enmSdm'))  %dopar% {
  ...
  # export table to disk:
  write.csv(dat_inv, paste0("../eval_metrics/INVASIVE/BIAS_BIOTIC_HABITAT/EXTRAPOL/2.5E/inv_region_tables/", species, "_inv_region_table.csv"), row.names = FALSE)
...
for (species in species_list) {
  ...
  # import invasive occurrence data and pred rasters:
  dat_inv <- read.csv(paste0("../eval_metrics/INVASIVE/BIAS_BIOTIC_HABITAT/EXTRAPOL/2.5E/inv_region_tables/", species, "_inv_region_table.csv"))
  glm_pred_inv_rst <- rast(paste0("../pred_rastersBIAS_BIOTIC_HABITAT/EU/invasive/", species, "_inv_p_glm.tif"))
  bart_pred_inv_rst <- rast(paste0("../pred_rastersBIAS_BIOTIC_HABITAT/EU/invasive/", species, "_inv_p_bart.tif"))
  fne_pred_inv_rst <- rast(paste0("../../0_Nf_modeling/ResultsClimBioticHabitat/", species, "_suitability_map_inv.tif"))
...
write.csv(mtp_thresholds, "../eval_metrics/INVASIVE/BIAS_BIOTIC_HABITAT/EXTRAPOL/2.5E/mtp_thresholds.csv", row.names = FALSE)
write.csv(data.frame(species = rownames(eval_metrics_eur_full), eval_metrics_eur_full), "../eval_metrics/INVASIVE/BIAS_BIOTIC_HABITAT/EXTRAPOL/2.5E/eval_metrics_eur_full.csv", row.names = FALSE)
write.csv(data.frame(species = rownames(eval_metrics_eur_mop), eval_metrics_eur_mop), "../eval_metrics/INVASIVE/BIAS_BIOTIC_HABITAT/EXTRAPOL/2.5E/eval_metrics_eur_mop.csv", row.names = FALSE)
write.csv(data.frame(species = rownames(eval_metrics_inv_full), eval_metrics_inv_full), "../eval_metrics/INVASIVE/BIAS_BIOTIC_HABITAT/EXTRAPOL/2.5E/eval_metrics_inv_full.csv", row.names = FALSE)
write.csv(data.frame(species = rownames(eval_metrics_inv_mop), eval_metrics_inv_mop), "../eval_metrics/INVASIVE/BIAS_BIOTIC_HABITAT/EXTRAPOL/2.5E/eval_metrics_inv_mop.csv", row.names = FALSE)
