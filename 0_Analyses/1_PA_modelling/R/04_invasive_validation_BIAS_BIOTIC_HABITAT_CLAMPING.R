...
dir.create("../eval_metrics/INVASIVE/BIAS_BIOTIC_HABITAT/CLAMPING/5E/inv_region_tables/")
dir.create("../eval_metrics/INVASIVE/BIAS_BIOTIC_HABITAT/MOP_JPGs")
...
foreach (species = species_list,.packages=c('terra','modEvA','kuenm','raster','enmSdm'))  %dopar% {
  ...
  glm_pred_inv_rst <- rast(paste0("../pred_rastersBIAS_BIOTIC_HABITAT_CLAMPING/EU/invasive/", species, "_inv_p_glm.tif"))
  bart_pred_inv_rst <- rast(paste0("../pred_rastersBIAS_BIOTIC_HABITAT_CLAMPING/EU/invasive/", species, "_inv_p_bart.tif"))
  fne_pred_inv_rst <- rast(paste0("../../0_Nf_modeling/ResultsClimBioticHabitatClamping/", species, "_suitability_map_inv.tif"))
  ...
  jpeg(paste0("../eval_metrics/INVASIVE/BIAS_BIOTIC_HABITAT/MOP_JPGs/", species, "_MOP.jpg"))
  ...
  write.csv(dat_inv, paste0("../eval_metrics/INVASIVE/BIAS_BIOTIC_HABITAT/CLAMPING/5E/inv_region_tables/", species, "_inv_region_table.csv"), row.names = FALSE)
...
for (species in species_list) {
  ...
  occ_nat <- read.csv(paste0("../../0_Nf_modeling/occurrences-v3/", species, "_native.csv"))
  acc_nat <- read.csv(paste0("../../0_Nf_modeling/accessible-areas-v3/", species, "_native_range.csv"))
  glm_pred_nat_rst <- rast(paste0("../pred_rastersBIAS_BIOTIC_HABITAT_CLAMPING/native/", species, "_nat_p_glm.tif"))
  bart_pred_nat_rst <- rast(paste0("../pred_rastersBIAS_BIOTIC_HABITAT_CLAMPING/native/", species, "_nat_p_bart.tif"))
  fne_pred_nat_rst <- rast(paste0("../../0_Nf_modeling/ResultsClimBioticHabitatClamping/", species, "_suitability_map_nat.tif"))
  ...
  dat_inv <- read.csv(paste0("../eval_metrics/INVASIVE/BIAS_BIOTIC_HABITAT/CLAMPING/5E/inv_region_tables/", species, "_inv_region_table.csv"))
  glm_pred_inv_rst <- rast(paste0("../pred_rastersBIAS_BIOTIC_HABITAT_CLAMPING/EU/invasive/", species, "_inv_p_glm.tif"))
  bart_pred_inv_rst <- rast(paste0("../pred_rastersBIAS_BIOTIC_HABITAT_CLAMPING/EU/invasive/", species, "_inv_p_bart.tif"))
  fne_pred_inv_rst <- rast(paste0("../../0_Nf_modeling/ResultsClimBioticHabitatClamping/", species, "_suitability_map_inv.tif"))
...
temp$V2 <- rep("climate_biotic_habitat",nrow(temp))
temp$V3 <- rep("clamping",nrow(temp))
temp$V4 <- rep("5",nrow(temp))
colnames(temp) <- c("BIAS_BIOTIC_HABITAT","preds","extrapol","threshold")
...
write.csv(mtp_thresholds, "../eval_metrics/INVASIVE/BIAS_BIOTIC_HABITAT/CLAMPING/5E/mtp_thresholds.csv", row.names = FALSE)

write.csv(data.frame(species = rownames(eval_metrics_eur_full), eval_metrics_eur_full), "../eval_metrics/INVASIVE/BIAS_BIOTIC_HABITAT/CLAMPING/5E/eval_metrics_eur_full.csv", row.names = FALSE)
write.csv(data.frame(species = rownames(eval_metrics_eur_mop), eval_metrics_eur_mop), "../eval_metrics/INVASIVE/BIAS_BIOTIC_HABITAT/CLAMPING/5E/eval_metrics_eur_mop.csv", row.names = FALSE)
write.csv(data.frame(species = rownames(eval_metrics_inv_full), eval_metrics_inv_full), "../eval_metrics/INVASIVE/BIAS_BIOTIC_HABITAT/CLAMPING/5E/eval_metrics_inv_full.csv", row.names = FALSE)
write.csv(data.frame(species = rownames(eval_metrics_inv_mop), eval_metrics_inv_mop), "../eval_metrics/INVASIVE/BIAS_BIOTIC_HABITAT/CLAMPING/5E/eval_metrics_inv_mop.csv", row.names = FALSE)
...
dir.create("../eval_metrics/INVASIVE/BIAS_BIOTIC_HABITAT/CLAMPING/2.5E/inv_region_tables/")
dir.create("../eval_metrics/INVASIVE/BIAS_BIOTIC_HABITAT/MOP_JPGs")
...
foreach (species = species_list,.packages=c('terra','modEvA','kuenm','raster','enmSdm'))  %dopar% {
  ...
  # export table to disk:
  write.csv(dat_inv, paste0("../eval_metrics/INVASIVE/BIAS_BIOTIC_HABITAT/CLAMPING/2.5E/inv_region_tables/", species, "_inv_region_table.csv"), row.names = FALSE)
...
for (species in species_list) {
  ...
  # import invasive occurrence data and pred rasters:
  dat_inv <- read.csv(paste0("../eval_metrics/INVASIVE/BIAS_BIOTIC_HABITAT/CLAMPING/2.5E/inv_region_tables/", species, "_inv_region_table.csv"))
  glm_pred_inv_rst <- rast(paste0("../pred_rastersBIAS_BIOTIC_HABITAT_CLAMPING/EU/invasive/", species, "_inv_p_glm.tif"))
  bart_pred_inv_rst <- rast(paste0("../pred_rastersBIAS_BIOTIC_HABITAT_CLAMPING/EU/invasive/", species, "_inv_p_bart.tif"))
  fne_pred_inv_rst <- rast(paste0("../../0_Nf_modeling/ResultsClimBioticHabitatClamping/", species, "_suitability_map_inv.tif"))
...
write.csv(mtp_thresholds, "../eval_metrics/INVASIVE/BIAS_BIOTIC_HABITAT/CLAMPING/2.5E/mtp_thresholds.csv", row.names = FALSE)
write.csv(data.frame(species = rownames(eval_metrics_eur_full), eval_metrics_eur_full), "../eval_metrics/INVASIVE/BIAS_BIOTIC_HABITAT/CLAMPING/2.5E/eval_metrics_eur_full.csv", row.names = FALSE)
write.csv(data.frame(species = rownames(eval_metrics_eur_mop), eval_metrics_eur_mop), "../eval_metrics/INVASIVE/BIAS_BIOTIC_HABITAT/CLAMPING/2.5E/eval_metrics_eur_mop.csv", row.names = FALSE)
write.csv(data.frame(species = rownames(eval_metrics_inv_full), eval_metrics_inv_full), "../eval_metrics/INVASIVE/BIAS_BIOTIC_HABITAT/CLAMPING/2.5E/eval_metrics_inv_full.csv", row.names = FALSE)
write.csv(data.frame(species = rownames(eval_metrics_inv_mop), eval_metrics_inv_mop), "../eval_metrics/INVASIVE/BIAS_BIOTIC_HABITAT/CLAMPING/2.5E/eval_metrics_inv_mop.csv", row.names = FALSE)
