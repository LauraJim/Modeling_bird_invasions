...
data.niche_th_env <- read.table("E:/Modeling_bird_invasions/0_Analyses/2_broenni/eu_disp/niche_results_th_env.txt",sep="\t",h=T)
...
niche.dyn.stab_vio <- ggplot(data.niche_th_env, aes(x=as.factor(threshold), y=stability.index)) + geom_violin()  
  ...
  setwd("E:/Modeling_bird_invasions/0_Analyses/2_broenni/eu_disp")
...
#median
  ...
  niche.summary <- data.niche_th_env.75 %>%summarise(niche_overlap_F.D.median = median(niche_overlap_F),
                                                     niche_overlap_F.D.sd = sd(niche_overlap_F),
                                                     niche_overlap_F.T.median = median(niche_overlap_T),
                                                     niche_overlap_F.T.sd = sd(niche_overlap_T),
