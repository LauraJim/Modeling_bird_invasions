...
eur_full <- read.csv(paste0("../PA_modelling/DS/2.5E/DS_eval_metrics/", "eval_metrics_eur_full.csv"))
  eur_full$bg <- rep("eur_full",nrow(eur_full))
eur_mess <- read.csv(paste0("../PA_modelling/DS/2.5E/DS_eval_metrics/", "eval_metrics_eur_mess.csv"))
  eur_mess$bg <- rep("eur_mess",nrow(eur_mess))
inv_full <- read.csv(paste0("../PA_modelling/DS/2.5E/DS_eval_metrics/", "eval_metrics_inv_full.csv"))
  inv_full$bg <- rep("inv_full",nrow(inv_full))
inv_mess <- read.csv(paste0("../PA_modelling/DS/2.5E/DS_eval_metrics/", "eval_metrics_inv_mess.csv"))
...
#read in SDM model evaluation statistics
eur_full <- read.csv(paste0("../PA_modelling/DS/2.5ECL/DS_eval_metrics/", "eval_metrics_eur_full.csv"))
eur_full$bg <- rep("eur_full",nrow(eur_full))
eur_mess <- read.csv(paste0("../PA_modelling/DS/2.5ECL/DS_eval_metrics/", "eval_metrics_eur_mess.csv"))
eur_mess$bg <- rep("eur_mess",nrow(eur_mess))
inv_full <- read.csv(paste0("../PA_modelling/DS/2.5ECL/DS_eval_metrics/", "eval_metrics_inv_full.csv"))
inv_full$bg <- rep("inv_full",nrow(inv_full))
inv_mess <- read.csv(paste0("../PA_modelling/DS/2.5ECL/DS_eval_metrics/", "eval_metrics_inv_mess.csv"))
inv_mess$bg <- rep("inv_mess",nrow(inv_mess))
...
eval_data_clamping$extrapol_method <- rep("clamping",nrow(eval_data_clamping))
